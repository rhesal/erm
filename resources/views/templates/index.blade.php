    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a
                    href="https://rsukarsahusadabatu.jatimprov.go.id/pelayanan/nonmedis/sistem_informasi"
                    target="_blank">Unit Teknologi Informasi - RSUD Karsa Husada Batu</a></strong>
        </footer>
